  ...
  const [score, setScore] = useState([
    {
      ...
      reviewComment2:
        "이제 갓 대학생된 푸릇한 대학생이에요 본가랑 학교가 멀어서 할머니집에서 생활하는데 할머니집이 오래되기도 해서 이번에 아버지께서 인테리어 새로 해주셨어요. 전에 친구네 자취방 놀러갔다가 그 느낌 내고싶어서 관리팀장님께 사진보여주면서 말했는데 상상이상이에요. 이 방에서 공부하면 a+도 받을 수 있을 것 같고 남친도 바로 생길것 같아옄ㅋㅋ  제 방뿐만 아니라 할머니도 만족하세요 연세가 많으셔서 걱정했는데 방문 턱이랑 계단도 이번에 없앴습니다 요즘은 본가보다 할머니집이 더 좋아요 최곱니다",
      reviewComment3:
